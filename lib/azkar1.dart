...
class azkar1 extends StatefulWidget {
  State<StatefulWidget> createState() {
    return azkar1State();
  }
}

class azkar1State extends State<azkar1> {
  List s = [
  ...
  "أصْبَـحْـنا وَأَصْبَـحْ المُـلكُ للهِ رَبِّ العـالَمـين ، اللّهُـمَّ إِنِّـي أسْـأَلُـكَ خَـيْرَ هـذا الـيَوْم ، فَـتْحَهُ ، وَنَصْـرَهُ ، وَنـورَهُ وَبَـرَكَتَـهُ ، وَهُـداهُ ، وَأَعـوذُ بِـكَ مِـنْ شَـرِّ ما فـيهِ وَشَـرِّ ما بَعْـدَه"
  ...
  List c=["1","3","3","3","1","1","3","4","1","7","3","1","1","3","3","3","1","3","1","1","3","10","3","3","3","10","1","100"];
  @override
                            ...
                            child:  Column(
                              ...
                              title:
                                ...
                                ,subtitle: ElevatedButton(onPressed: () {},style: ElevatedButton.styleFrom(backgroundColor: Colors.amberAccent.shade700)
                                    ,child: Text("  التكرار:  ${c[i]} ",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,),)),)]
                            ),
                          ),
                      ),
                        );
